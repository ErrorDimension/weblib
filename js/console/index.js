...
class Console {
    ...
    text;
    displayTo;
    constructor(text, { color = 'white', background = 'rgb(255, 255, 255)', opacity = 0.55, displayTo = null } = {}) {
        function toRgba(clr) {
    ...
    static display(query, { code = -1, description = 'Unknown', message = (cd, des) => `[${cd}] >>> ${des}`, title = (cd = '', des = '') => `💣 Oh shit, it's an ERROR !!!` } = {}) {
